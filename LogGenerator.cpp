...
int main(int argc, char* argv[]) {
    ...
    string apiPath[6] = {"/api/v1/auth/login", "/api/v1/users/profile", "/static/bundle.js", "/index.html", "/api/v2/stream/sync", "/health"};
    string stateCode[11] = {"200", "201", "204", "304", "400", "401", "403", "404", "500", "502", "503"};
